...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'A professional blog platform')">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            {{-- @php
                                $navCategories = \App\Models\PostCategory::take(6)->get();
                            @endphp --}}
                            {{-- @foreach($navCategories as $cat)
                                <li>
                                    <a class="dropdown-item" href="{{ route('blog.category', $cat->slug) }}">
                                        {{ $cat->name }}
                                    </a>
                                </li>
                            @endforeach --}}

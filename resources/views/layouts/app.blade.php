        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('category.work.index') }}" class="nav-link">
                            <i class="bi bi-briefcase"></i>
                            <span>Work</span>
                            <span class="badge bg-info">{{ $sideBarCategoryCount['workCount'] }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('category.personal.index') }}" class="nav-link">
                            ...
                            <span>Personal</span>
                            <span class="badge bg-success">{{ $sideBarCategoryCount['personalCount'] }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('category.shopping.index') }}" class="nav-link">
                            <i class="bi bi-cart"></i>
                            <span>Shopping</span>
                            <span class="badge bg-warning">{{ $sideBarCategoryCount['shoppingCount'] }}</span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="nav-section">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a href="{{ route('task.today') }}" class="nav-link">
                            <i class="bi bi-calendar-day"></i>
                            <span>Today's Tasks</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('task.important') }}" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('task.overdue') }}" class="nav-link">

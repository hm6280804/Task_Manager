...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <!-- Search and Filters -->
            <form method="GET" action="{{ route('task.overdue') }}" class="row g-3">
                <div class="col-md-4">

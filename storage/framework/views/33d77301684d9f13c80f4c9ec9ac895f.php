...
unset($__errorArgs, $__bag); ?>" 
                                   id="color" 
                                   name="color" 
                                   value="<?php echo e($category->color); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                  ...
                                  name="description" 
                                  rows="3" 
                                  placeholder="Brief description of this category"><?php echo e($category->description); ?></textarea>
            ...
            <div class="card-body">
                <div class="category-preview" id="categoryPreview">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h5 class="mb-0" id="previewName"><?php echo e($category->name); ?></h5>
                            <small class="text-muted">0 tasks</small>
                        </div>
                    </div>
                    <p class="text-muted small" id="previewDescription"><?php echo e($category->description); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Software_Development\laravel_Projects\Task_Management\resources\views/categories/edit.blade.php ENDPATH**/ ?>
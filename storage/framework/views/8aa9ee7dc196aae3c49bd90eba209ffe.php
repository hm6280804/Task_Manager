...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            <h1 class="page-title">All Completed Tasks</h1>
            ...
            <ul class="nav nav-pills mb-3">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('status', 'all') == 'all' ? 'active' : ''); ?>"
                        href="<?php echo e(route('task.completed')); ?>">
                        Completed <span class="badge bg-secondary ms-1"><?php echo e($counts['all']); ?></span>
                    </a>
                </li>
            </ul>

            <!-- Search and Filters -->
            <form method="GET" action="<?php echo e(route('task.completed')); ?>" class="row g-3">
                <div class="col-md-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Software_Development\laravel_Projects\Task_Management\resources\views/tasks/completed.blade.php ENDPATH**/ ?>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="display-4 fw-bold mb-3"><?php echo e($featuredPost->title); ?></h1>
                        <p class="lead mb-4"> <?php echo e($featuredPost->excerpt ?? ''); ?></p>
                        <div class="d-flex align-items-center gap-3 mb-4">
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($featuredPost->user->name)); ?>&background=random"
                                class="rounded-circle" width="40" height="40" alt="<?php echo e($featuredPost->user->name); ?>">
                            <div>
                                <div class="fw-semibold"><?php echo e($featuredPost->user->name); ?></div>
                    ...
                    <div class="col-lg-6">
                        <?php if(0): ?>
                            <img src="<?php echo e(asset('storage/' . $featuredPost->featured_image)); ?>"
                                class="img-fluid rounded shadow-lg" alt="<?php echo e($featuredPost->title); ?>">
                        <?php else: ?>
                    ...
                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card post-card h-100 border-0 shadow-sm">
                                <?php if(0): ?>
                                    <img src="<?php echo e(asset('storage/' . $post->featured_image)); ?>" class="card-img-top"
...
<h5 class="card-title">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                <div class="d-flex align-items-center gap-2">
                                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($post->user->name)); ?>&size=32&background=random" 
                        ...
                        <div class="card-footer bg-white border-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <small class="text-muted">
                                    <i class="bi bi-eye me-1"></i><?php echo e($post->view_count); ?> views
                                </small>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.blog', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Software_Development\laravel_Projects\Task_Management\resources\views/settings/test1.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <ul class="nav nav-pills mb-3">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('status', 'all') == 'all' ? 'active' : ''); ?>"
                        href="<?php echo e(route('task.today')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('status') == 'pending' ? 'active' : ''); ?>"
                        href="<?php echo e(route('task.today', ['status' => 'pending'])); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('status') == 'in_progress' ? 'active' : ''); ?>"
                        href="<?php echo e(route('task.today', ['status' => 'in_progress'])); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('status') == 'completed' ? 'active' : ''); ?>"
                        href="<?php echo e(route('task.today', ['status' => 'completed'])); ?>">
            ...
            <!-- Search and Filters -->
            <form method="GET" action="<?php echo e(route('task.today')); ?>" class="row g-3">
                <div class="col-md-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Software_Development\laravel_Projects\Task_Management\resources\views/tasks/today.blade.php ENDPATH**/ ?>
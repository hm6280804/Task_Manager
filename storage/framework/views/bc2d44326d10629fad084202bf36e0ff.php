    ...
    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 category-card"
                 style="border-left: 4px solid <?php echo e($category->color); ?>;">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div class="d-flex align-items-center gap-3">
                            <div class="category-icon"
                                 style="background: <?php echo e($category->color); ?>20; color: <?php echo e($category->color); ?>;">
                                <i class="<?php echo e($category->icon ?? 'bi-folder'); ?>"></i>
                            </div>
                            <div>
                                <h5 class="mb-0"><?php echo e($category->name); ?></h5>
                                <small class="text-muted">
                                    <?php echo e($total); ?> Tasks
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('category.tasks', $category->id)); ?>">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <small class="text-muted">
                                <?php echo e($completed); ?> / <?php echo e($total); ?>
                        ...
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar"
                                 role="progressbar"
                                 style="width: <?php echo e($progress); ?>%; background-color: <?php echo e($category->color); ?>;"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Software_Development\laravel_Projects\Task_Management\resources\views/categories/index.blade.php ENDPATH**/ ?>
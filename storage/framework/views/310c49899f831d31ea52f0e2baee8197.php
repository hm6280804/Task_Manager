            ...
            <ul class="nav nav-pills mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('status') == 'pending' ? 'active' : ''); ?>"
                        href="<?php echo e(route('tasks.index', ['status' => 'pending'])); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('status') == 'in_progress' ? 'active' : ''); ?>"
                        href="<?php echo e(route('tasks.index', ['status' => 'in_progress'])); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('status') == 'completed' ? 'active' : ''); ?>"
                        href="<?php echo e(route('tasks.index', ['status' => 'completed'])); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Software_Development\laravel_Projects\Task_Management\resources\views/tasks/index.blade.php ENDPATH**/ ?>